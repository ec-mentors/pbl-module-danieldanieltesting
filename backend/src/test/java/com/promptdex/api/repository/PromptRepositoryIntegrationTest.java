...
public class PromptRepositoryIntegrationTest {
    ...
    void setUp() {
        ...
        // Create Prompts with specific attributes for filtering
        prompt1 = new Prompt();
        ...
        prompt3.setPromptText("A prompt about advanced java testing techniques."); // <-- THIS WAS MISSING
        ...
        prompt4.setPromptText("A prompt about SQL."); // <-- THIS WAS MISSING
