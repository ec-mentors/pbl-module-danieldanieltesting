...
@Service
@Transactional(readOnly = true) // Most stats operations will be read-only
public class AdminStatsService {
    ...
    // You can add more methods here for more specific statistics later,
    // e.g., promptsPerCategory, newUsersLast7Days, etc.
}